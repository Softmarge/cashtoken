...
export type HomeTab = 'home' | 'business' | 'customers' | 'marketplace' | 'team';
...
const UK_HomeTabBar: React.FC<HomeTabBarProps> = ({ activeTab, onTabChange }) => {
                    ...
                    >
                      <div className={`flex-shrink-0 ${isActive ? 'text-white' : ''}`} style={{ color: isActive ? 'white' : tab.color }}>
                        <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round">
                          ...
                          {tab.key === 'customers' && <><path d="M20 21v-2a4 4 0 0 0-4-4H8a4 4 0 0 0-4 4v2" /><circle cx="12" cy="7" r="4" /></>}
                          {tab.key === 'marketplace' && <><circle cx="9" cy="21" r="1" /><circle cx="20" cy="21" r="1" /><path d="M1 1h4l2.68 13.39a2 2 0 0 0 2 1.61h9.72a2 2 0 0 0 2-1.61L23 6H6" /></>}
